...
support. Technicians are available Monday-Saturday. Same-week appointments usually available. A
$99 diagnostic fee applies but is waived if repairs are completed."""
    },
...
offer premium features and wide shelves. Side-by-side provides equal fridge/freezer access. Top
freezer is most affordable. Counter-depth for seamless look. Smart refrigerators offer
...
transition rear to forward-facing (up to 65 lbs). Booster seats for children 40-100 lbs. All
seats must meet FMVSS 213 standards. Check expiration dates (6-10 years). LATCH system for
easy installation. Never use a car seat after an accident. Free installation checks at local
fire stations."""
    },
...
to pasta making, meat grinding, and food processing. Metal construction is most durable."""
    ...
    "product_gaming_console": {
        ...
        "category": "products",
        "content": """PlayStation 5: Best exclusive games, powerful hardware, VR capability. Xbox
Series X: Game Pass subscription value, backward compatibility. Nintendo Switch: Portable gaming,
family-friendly exclusives. Consider: exclusive game titles, online subscription costs,
storage capacity (expandable options), controller preferences. All support 4K gaming and
streaming apps."""
    },
    "payment_methods": {
